...
?>
    ...
    <div class="container-fluid" id="contact-container">
                ...
                <div class="row">
                    ...
                    <form id="contact-form" action="processfb.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary" name="feedback-submit" id="feedback-submit">Submit</button><span class="spin-margin" id="ajax-spin"><img src ='../assets/images/ajax-loader.gif' ></span>
...
?>
    ...
    <!--Form Validation-->
    <script src="../assets/js/contact-us1.js"></script>
    <script>
        var start = 100;
        var mid = 145;
        var end = 250;
