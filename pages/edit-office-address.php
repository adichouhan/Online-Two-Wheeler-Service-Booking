<?php
    ...
    if(isset($_POST['add'])){
        ...
        {
            $officeAddr =validateFormData($_POST['address']);
            $query = "update address set address='$officeAddr' where addresstype = 2 AND uid=$id";
    //store result
...
?>
    ...
    <form action='<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>' method="POST" class="form-horizontal">
        ...
        <div class="form-group">
               ...
               <textarea class="form-control input-lg" id="address" name="address"><?php echo htmlspecialchars($officeAddr); ?></textarea>
